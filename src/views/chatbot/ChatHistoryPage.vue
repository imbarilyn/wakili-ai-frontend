...
// push the history chats for viewing
chatbotStore.chatHistoryContent.forEach((history)=>{
  const historyChat = ref<Conversation>({
    message: history.content,
    isUser: history.isUser==='1',
    uniqueId: _.uniqueId('history-')
  })

  conversation.value.push(historyChat.value)
